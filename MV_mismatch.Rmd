...
```{r}
pls_16s_test <- pls(X = abundance16S_agg_forfitting, Y = trait_post_blups[101,,], ncomp = 2)
pls_16s_test <- pls(X = abundance16S_agg_forfitting, Y = trait_post_blups[101,,1], ncomp = 1)
```
